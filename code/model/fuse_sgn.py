...
class FuseSGN(nn.Module):
    ...
    def forward(self, input):
        ...
        prob, action = get_fixed_action(bs*m*s, len(self.num_joints), t)  # batch_size num_action 1 t
...
if __name__ == '__main__':
    ...
    model = FuseSGN(60, num_js, num_t, transforms=["M25to5", "M25to13"])
