...
# parser.add_argument('--joint', default='../work_dir/ntu60/sgnadapre_alpha06warm5_policyran_lineartau5_transformfix30_models6fix30_lr0001')
# parser.add_argument('--bone', default='../work_dir/ntu60/sgnadapre_alpha06warm5_policyran_lineartau5_transformfix30_models6fix30_lr0001_bone')
# parser.add_argument('--vel', default='../work_dir/ntu60/sgnadapre_alpha06warm5_policyran_lineartau5_transformfix30_models6fix30_lr0001_vel')
...
# parser.add_argument('--joint', default='../work_dir/ntu60cv/sgnadapre_alpha06warm5_policyran_lineartau5_transformfix30_models6fix30_lr0001_rotnorm')
# parser.add_argument('--bone', default='../work_dir/ntu60cv/sgnadapre_alpha06warm5_policyran_lineartau5_transformfix30_models6fix30_lr0001_rotnorm_bone')
# parser.add_argument('--vel', default='../work_dir/ntu60cv/sgnadapre_alpha06warm5_policyran_lineartau5_transformfix30_models6fix30_lr0001_rotnorm_vel')
...
parser.add_argument('--alpha', default=[3, 2, 1, 0, 0], help='weighted summation')
